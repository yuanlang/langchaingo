...
import (
	...
	"github.com/yuanlang/langchaingo/llms/googleai"
	"github.com/yuanlang/langchaingo/llms/googleai/vertex"
)
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart(
			"https://github.com/yuanlang/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true",
		),
